            ...
            {activeTab === "list" && (
                <div className="space-y-4">
                    <input
                        ...
                        className="w-full max-w-md bg-white border border-gray-200 text-gray-900 px-4 py-2 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-400"
                    />
                                        ...
                                        <tbody className="divide-y divide-gray-100">
                                            {filtered.map((c) => (
                                                <tr key={c.id} className="hover:bg-gray-50 transition-colors group">
                                                    ...
                                                    <td className="px-6 py-3 text-gray-600 font-mono">+{c.phone}</td>
                                                    <td className="px-6 py-3">
                                                        <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-xs">
                                                            {c.source || 'Recibido'}
                                                        </span>
                                                    </td>
                                                    <td className="px-6 py-3 text-gray-500">{c.totalMessages}</td>
                                                    <td className="px-6 py-3">
                                                        {c.hasWindow ? (
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {status === "mapping" && (
                            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm text-red-600 mb-1">Teléfono (Requerido) *</label>
                                        <select
                                            value={mapping.phone}
                                            onChange={(e) => setMapping({ ...mapping, phone: e.target.value })}
                                            className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500/20"
                                        >
                                ...
                                <div className="mt-6">
                                    <h4 className="text-sm text-gray-500 mb-2">Vista Previa (5 filas)</h4>
                                            ...
                                            <tbody>
                                                {previewData.map((row, i) => (
                                                    <tr key={i} className="border-b border-gray-100">
                                                        <td className="px-4 py-2 text-gray-900">{mapping.phone ? row[mapping.phone] : "-"}</td>
                        ...
                        {status === "uploading" && (
                            <div className="bg-white p-10 min-h-[300px] rounded-xl border border-gray-200 shadow-sm flex flex-col items-center justify-center space-y-4">
                                ...
                                <h3 className="text-gray-900 font-medium text-lg">Procesando y Guardando Contactos...</h3>
                            </div>
                        )}
                        ...
                        {status === "success" && results && (
                            <div className="bg-white p-8 rounded-xl border border-green-200 shadow-sm text-center space-y-4">
                                ...
                                <p className="text-green-600">{results.success} contactos listos en la base de datos.</p>
                        ...
                        {status === "error" && results && (
                            <div className="bg-white p-8 rounded-xl border border-red-200 shadow-sm text-center space-y-4">
                                ...
                                <h3 className="text-xl font-bold text-gray-900">Fallo en la importación</h3>
